...
fn updatePoint(point: *Point) void {
    ...
    point.position[0] += point.velocity[0] * speed;
    point.position[1] += point.velocity[1] * speed;
    ...
    if (point.orbit.center) |center| {
        point.orbit.angle += point.orbit.speed * speed;
...
fn oscillatePoint(point: *Point) void {
    ...
    point.oscillation.offset += 0.1 * audio.speed_scale;
}
